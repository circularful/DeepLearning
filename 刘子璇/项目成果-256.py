...
class picture(QMainWindow):
    content_array = np.arange(196608).reshape(1, 256, 256, 3)
    style_array = np.arange(196608).reshape(1, 256, 256, 3)
